...
function checkPasswordMatch() {
  ...
  if (password_confirmation.value !== "") {
    if (password.value === password_confirmation.value) {
      password_match_message.innerHTML = '<h1 style="color: green;">Passwords match</h1>';
    } else {
      password_match_message.innerHTML = '<h1 style="color: red;">Passwords not match</h1>';
    }
  } else {
...
/******/ });
//# sourceMappingURL=application-4ffb152733457f916647.js.map