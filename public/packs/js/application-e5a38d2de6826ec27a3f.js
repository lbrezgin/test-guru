...
function checkPasswordMatch() {
  var password = document.getElementById("<%= resource_name %>_password").value;
  var confirmPassword = document.getElementById("<%= resource_name %>_password_confirmation").value;
  var passwordStatus = document.getElementById("passwordStatus");
  if (confirmPassword === "") {
    passwordStatus.innerHTML = "";
  } else if (password === confirmPassword) {
    passwordStatus.innerHTML = "<span class='password-match'>Passwords match</span>";
  } else {
    passwordStatus.innerHTML = "<span class='password-mismatch'>Passwords do not match</span>";
  }
...
/******/ });
//# sourceMappingURL=application-e5a38d2de6826ec27a3f.js.map