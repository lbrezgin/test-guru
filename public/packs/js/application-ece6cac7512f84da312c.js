...
document.addEventListener('turbolinks:load', function () {
  var check = document.getElementsByClassName('.myBar');
  if (check) {
    var progressBar = document.querySelector('.myBar');
    var _testPassage = progressBar.dataset.testPassageQuestions;
    var _currentQuestion = progressBar.dataset.testPassageCurrentQuestion;
  }
...
/******/ });
//# sourceMappingURL=application-ece6cac7512f84da312c.js.map