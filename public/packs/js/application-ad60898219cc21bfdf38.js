...
document.addEventListener('turbolinks:load', function () {
  ...
  if (check) {
    var _progressBar = document.getElementById('myBar');
    var testPassage = _progressBar.dataset.testPassageQuestions;
    var currentQuestion = _progressBar.dataset.testPassageCurrentQuestion;
...
/******/ });
//# sourceMappingURL=application-ad60898219cc21bfdf38.js.map