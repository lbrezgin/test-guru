...
function checkPasswordMatch() {
  ...
  if (password_confirmation.value !== "") {
    if (password.value === password_confirmation.value) {
      password_match_message.innerHTML = '<span class="octicon octicon-check" style="color: green;"></span> Passwords match';
    } else {
      password_match_message.innerHTML = '<span class="octicon octicon-x" style="color: red;"></span> Passwords do not match';
    }
  } else {
    password_match_message.innerHTML = ""; // Clear the message if password_confirmation is empty
  }
}
...
/******/ });
//# sourceMappingURL=application-d4dfc45a7c7924c628b0.js.map