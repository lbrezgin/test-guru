...
document.addEventListener('turbolinks:load', function () {
  ...
  control.addEventListener('click', sortRowsByTitle); //отслеживаем у сохраненного элемента событие клик, и когда оно случается передаем функцию
});
function sortRowsByTitle() {
  var table = document.querySelector('table');
  var tbody = table.querySelector('tbody'); // предполагается, что ваши строки находятся внутри элемента tbody

  var rows = Array.from(tbody.querySelectorAll('tr')).slice(1); // преобразование NodeList в массив и исключение строки заголовка
  ...
  sortedTable.appendChild(table.querySelector('thead').cloneNode(true));
  sortedTable.appendChild(newTbody);
...
/******/ });
//# sourceMappingURL=application-6cd71bd76d61faa8cf41.js.map