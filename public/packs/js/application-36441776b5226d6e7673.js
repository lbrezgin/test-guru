...
function checkPasswordMatch() {
  ...
  if (password_confirmation.value !== "") {
    if (password.value === password_confirmation.value) {
      password_match_message.innerHTML = '<span class="octicon arrow-up" style="color: green;"></span> Passwords match';
    } else {
      password_match_message.innerHTML = '<span class="octicon arrow-down" style="color: red;"></span> Passwords do not match';
    }
  } else {
...
/******/ });
//# sourceMappingURL=application-36441776b5226d6e7673.js.map