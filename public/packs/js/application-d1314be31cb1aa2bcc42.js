...
function sortRowsByTitle() {
  ...
  var tbody = sortedTable.appendChild(document.createElement('tbody'));
...
function compareRowsAsc(left, right) {
  var leftTitle = left.querySelector('td').textContent;
  var rightTitle = right.querySelector('td').textContent;
...
/******/ });
//# sourceMappingURL=application-d1314be31cb1aa2bcc42.js.map