...
function checkPasswordMatch() {
  ...
  if (password.value !== "" && password_confirmation.value !== "") {
    if (password.value === password_confirmation.value) {
      password_match_message.innerHTML = '<i class="fas fa-check-circle" style="color: green;"></i> Passwords match';
    } else {
      password_match_message.innerHTML = '<i class="fas fa-times-circle" style="color: red;"></i> Passwords do not match';
    }
  }
}
...
/******/ });
//# sourceMappingURL=application-c635f8822654fe31aadc.js.map