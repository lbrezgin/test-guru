...
document.addEventListener('turbolinks:load', function () {
  ...
  if (check) {
    document.querySelector('#next-question').addEventListener('click', progressBarFunc);
  }
});
function progressBarFunc() {
  ...
  var percents = 100.0 / testPassage;
  console.log(testPassage);
  console.log(currentQuestion);
  document.getElementById('myBar').classList.add('myClass');
}
...
/******/ });
//# sourceMappingURL=application-67ee71acfab54bbdbe50.js.map